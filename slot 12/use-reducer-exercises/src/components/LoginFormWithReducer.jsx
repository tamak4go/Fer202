...
function signUpReducer(state, action) {
  switch (action.type) {
    case 'UPDATE_FIELD':
      // Cập nhật giá trị của một field và error tương ứng
      return {
        ...state,
        form: {
          ...state.form,
...
// ============================================
// VALIDATION FUNCTION (giống bản gốc)
// ============================================
function validate(field, value, formData) {
  switch (field) {
    case 'username':
...
function SignUpFormWithReducer() {
  ...
  // Memo hóa lỗi cho toàn bộ form (giống bản gốc)
